...
/**
Classe que representa uma solu��o do problema.
**/
class Solucao{
public:
    bitset<nElem> vectorBits;//Bitset da solu��o (interse��o)
    vector<bool> is_elem;//Vetor de tamanho igual a quantidade de vertices, onde o �ndice j ser� true se o subconjunto j est� na solu��o.
    vector<int> elem;//Vetor com os indices dos subconjuntos que pertecem a solu��o.
...
int Ler_arquivo(string caminho, int tipo){
    ...
    /**
    C�digo para o Pre-processamento que elimina elementos que est�o em quantidades de subconjuntos menor do que k.
    **/
